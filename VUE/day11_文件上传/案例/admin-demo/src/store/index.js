...
import GoodsTypeWeb2003Model from '../views/test/goods-type-web2003/goods-type-web2003-model.js'
import UserTestModel from '../views/test/user-test/user-test-model.js'
import CardTypeModel from '../views/type/card-type/card-type-model'
import CouponTypeModel from '../views/type/coupon-type/coupon-type-model'
import GoodsTypeModel from '../views/type/goods-type/goods-type-model.js'
import UserTypeModel from '../views/type/user-type/user-type-model'
Vue.use(Vuex)
//全局的数据中心
const store = new Vuex.Store({
	...
	modules: {
		...
		goodsTypeWeb2003Model: GoodsTypeWeb2003Model,
