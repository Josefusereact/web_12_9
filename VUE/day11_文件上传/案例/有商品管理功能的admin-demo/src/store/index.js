...
import GoodsModel from '../views/manage/goods/goods-model.js'
import NewsModel from '../views/manage/news/news-model.js'
import CardModel from '../views/manage/card/card-model'
import ShopUserModel from '../views/shop/shop-user/shop-user-model'
