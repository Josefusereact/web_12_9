<template>
<div>
    <el-page-header @back="handleBack" title="批量新增会员卡"></el-page-header>
    <el-row>
        <el-col :span="6">
            <el-form :model="addForm" :rules="rules" ref="addForm" label-width="auto">
                ...
                <el-form-item size="mini" prop="remark" label="数量">
                    <el-input clearable placeholder="请输入" v-model.number="addForm.count"></el-input>
                </el-form-item>
