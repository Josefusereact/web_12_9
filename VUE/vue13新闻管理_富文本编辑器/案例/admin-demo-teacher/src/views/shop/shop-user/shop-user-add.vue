...
<div>
    ...
    <el-row>
        <el-col :span="24">
            <el-form :model="addForm" label-width="auto" ref="addForm" :rules="rules">
                ...
                <el-form-item size="mini" prop="birthday" label="生日">
                    <el-date-picker v-model="addForm.birthday" format="yyyy-MM-dd" value-format="yyyy-MM-dd" align="right" type="date" placeholder="选择日期">
                    </el-date-picker>
                </el-form-item>
