...
<div class="page">
    ...
    <el-form inline :model="queryForm">
        ...
        <el-form-item size="mini" label="会员生日">
            <el-date-picker v-model="dateArr" type="daterange" format="yyyy-MM-dd" value-format="yyyy-MM-dd" @change="handleDateChange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期">
            </el-date-picker>
        </el-form-item>
    ...
    <el-table border size="mini" :data="list">
        ...
        <el-table-column label="头像">
            <template v-slot="{ row }">
                <el-image style="width: 100px; height: 100px; border-radius: 9px" fit="cover" :src="row.face" :preview-src-list="[row.face]">
                </el-image>
            </template>
        </el-table-column>
