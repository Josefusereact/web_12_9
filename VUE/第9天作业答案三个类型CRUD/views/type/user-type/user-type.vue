<template>
  <div class="page">
       <p-page-header title="商城会员类型管理"></p-page-header>
		<el-form inline :model="queryForm">
			<el-form-item size="mini" label="优惠券类型名称">
				<el-input placeholder="请输入类型名称" clearable v-model="queryForm.name"></el-input>
			</el-form-item>
...
export default {
    ...
    methods:{
        ...
        ...mapActions('userTypeModel',['getListForPage','deleteById']),
        // 点击查询按钮触发的⌚️
			async handleClick(){
